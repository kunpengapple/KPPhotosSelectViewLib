...
@interface KPSelectViewCollectionView ()
...
@implementation KPSelectViewCollectionView
...
- (void)handelItemInSpace {
    ...
    for (NSIndexPath *indexPath in totalArray) {
        KPPhotoSubViewCell *sectionLastCell = (KPPhotoSubViewCell *)[self cellForItemAtIndexPath:indexPath];
...
- (void)moveCell{
    ...
    for (KPPhotoSubViewCell *cell in [self visibleCells]) {
